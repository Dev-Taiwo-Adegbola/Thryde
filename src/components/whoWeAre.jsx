  ...
  return (
    ...
    >
      <div className="text-center w-[50%] max-lg:w-full">
        <h2 className="font-jerome text-4xl mb-3 text-[#15d46d] ">Who we Are?</h2>
      ...
      <div className="lg:flex max-lg:flex-col items-center justify-between max-md:justify-center ">
        <img
          src={thrydeRide}
          alt=""
          className="w-[45%] max-lg:w-full rounded-2xl shadow-2xl shadow-[#15d46d]/15"
        />
...
export const WhoWeAreUnit = ({ icon, title, description }) => {
  return (
    <div className="flex flex-col gap-4 w-[80%]">
      ...
      <p className="font-bold text-[#15d46d]">{title}</p>
